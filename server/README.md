...
- **Multiplayer Battles**: Real-time online matches with teams of 5v5 or free-for-all modes.
- **Tank Customization**: Equip your tank with various weapons, armors, and abilities.
- **Diverse Arenas**: Unique battlefields with destructible environments, power-ups, and strategic chokepoints.
- **Progression System**: Level up and unlock new tanks, upgrades, and skins.
- **Competitive Gameplay**: Ranked matches, leaderboards, and tournaments.
- **Cross-Platform Support**: Play on PC, console, or mobile devices.
...
- **Support**: Heals and buffs allies, debuffs enemies.
...
- **Enhanced AI Bots**: Smarter AI for training and offline play.
